...
**必须先读取项目 `AGENTS.md` 和 `.codex/rules/` 下所有规范文件**，设计方案必须遵循项目已有的技术规范和约定。
...
{基于 .codex/rules/security.md 和项目特有的安全规范}
...
- 当前代码项目的 `AGENTS.md` 和 `.codex/rules/`
