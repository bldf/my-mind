---
description: Generate development specs from requirement documents
argument-hint: specs folder path, or --change <feature> description
---
...
- **新建模式**：`/my:prd {项目文件夹路径}`
- **变更模式**：`/my:prd --change {N}.{feature-name} 变更内容描述`
