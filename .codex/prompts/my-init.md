---
description: Initialize Codex project guidance and rule files
argument-hint: optional project path or notes
---

# /my:init - 项目 Codex 初始化
...
- 如果 `AGENTS.md` 或 `.codex/` 已存在，先告知用户并询问是否覆盖
