...
调用 `Skill` 工具加载 `my-database-engineer`，严格按其工作流程执行。该 skill 是你的唯一行为准则来源，本文件只补充 subagent 特有的上下文纪律。
...
2. 代码项目的 `AGENTS.md` 与 `.codex/rules/`（重点 `database.md`、`security.md`、`coding-style.md`）
